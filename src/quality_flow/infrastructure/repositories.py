...
class RunRepository:
    ...
    def claim_queued_run(self, worker_id: str | None = None) -> Run | None:
    ...
    def record_terminal_result(
        ...
        terminal_run_status = {
            RunOutcome.PASSED: RunStatus.COMPLETED,
            RunOutcome.FAILED: RunStatus.COMPLETED,
            RunOutcome.INFRA_FAILED: RunStatus.INFRA_FAILED,
            RunOutcome.TIMED_OUT: RunStatus.TIMED_OUT,
        }[outcome]
